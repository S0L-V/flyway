    ...
    <nav class="flex-1 overflow-y-auto px-4 py-8 space-y-8">
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="${pageContext.request.contextPath}/admin/users" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all hover:bg-white/5 hover:text-white">
